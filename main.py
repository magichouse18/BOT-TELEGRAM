...
def button(update: Update, context: CallbackContext):
    ...
    if data == str(SHOP):
        ...
        query.edit_message_text("Contattaci per conoscere i prodotti disponibili CALI USA.", reply_markup=InlineKeyboardMarkup([])
            )
...
ℹ️Profilo Aromatico/Fruttato con note tropicale di agrumi""",
    ...
    context.bot.send_message(
        ...
        query.edit_message_text("Attualmente nessun prodotto disponibile nella categoria FROZEN.", reply_markup=InlineKeyboardMarkup([])
            )
    context.bot.send_message(
        chat_id=query.message.chat_id,
        text="La nostra selezione di hash per tutte le tipologie di smokers:",
